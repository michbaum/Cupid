_base_ = [
    './extended-kitti-panoptic-matching.py',
...
model = dict(
    # (michbaum) We just change the post-processing 
    type='CUPIDPanopticMatching',
    matching_instance_class=2, # (michbaum) We currently only match between boxes in the scene
)
