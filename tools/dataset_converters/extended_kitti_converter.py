...
def create_extended_kitti_info_file(data_path,
    ...
    kitti_infos_train = get_extended_kitti_image_info( # TODO: (michbaum) Adapt
        data_path,
        training=True,
        velodyne=True,
        calib=True,
...
# TODO: (michbaum) Check if this is neeeded, and if so if it needs changes
...
# TODO: (michbaum) Check if this needs changes
