...
from tools.dataset_converters import extended_kitti_converter as ekitti
...
def extended_kitti_data_prep(root_path,
                    info_prefix,
                    version,
                    out_dir,
                    with_plane=False):
    ...
    info_trainval_path = osp.join(out_dir, f'{info_prefix}_infos_trainval.pkl')
    info_test_path = osp.join(out_dir, f'{info_prefix}_infos_test.pkl')
    update_pkl_infos('extended_kitti', out_dir=out_dir, pkl_path=info_train_path)
