# Adapted from lidar_box3d.py by michbaum
...
# TODO: (michbaum) Adapt to more rotation angles
class LiDARInstance3DBoxes6DoF(BaseInstance3DBoxes):
    """3D boxes of instances in LIDAR coordinates with 3 rotation angles.
    ...
    the roll is around the x axis, the pitch is around the y axis,
    and the yaw is around the z axis. The roll is 0 at the positive direction
    of the z axis, and increases from the positive direction of z to the
    negative direction of y. The pitch is 0 at the positive direction of x
    axis, and increases from the positive direction of x to the negative
    direction of z. The yaw is 0 at the positive direction of x axis, and
    increases from the positive direction of x to the positive direction of y.

    Attributes:
        tensor (Tensor): Float matrix with shape (N, box_dim).
        box_dim (int): Integer indicating the dimension of a box. Each row is
            (x, y, z, x_size, y_size, z_size, yaw, pitch, roll, ...). Default
            is 9.
        with_yaw (bool): Whether the box is with rotation. If False, the
            value of yaw, pitch & roll will be set to 0 as minmax boxes. 
            Defaults to True.
    """
    ROLL_AXIS = 0
    PITCH_AXIS = 1
    ...
    # TODO: (michbaum) Make sure to use zyx-Euler angles (intrinsic) for rotation
    def rotate(
        self,
