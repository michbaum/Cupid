...
from mmdet3d.evaluation import seg_eval, cupid_panoptic_seg_eval
from mmdet3d.registry import METRICS


@METRICS.register_module()
class CUPIDPanopticMetric(BaseMetric):
    ...
    def __init__(self,
        ...
        super(CUPIDPanopticMetric, self).__init__(
    ...
    def process(self, data_batch: dict, data_samples: Sequence[dict]) -> None:
        ...
        for data_sample in data_samples:
            ...
            ins_3d = data_sample['pred_pts_ins']
            ...
            for k, v in pred_3d.items():
                if hasattr(v, 'to'):
                    ...
                    cpu_pred_3d[k] = v
            for k, v in ins_3d.items():
                if hasattr(v, 'to'):
                    cpu_pred_ins[k] = v.to('cpu').numpy()
                else:
                    cpu_pred_ins[k] = v
            self.results.append((eval_ann_info, cpu_pred_3d, cpu_pred_ins))
    ...
    def compute_metrics(self, results: list) -> Dict[str, float]:
        ...
        for eval_ann, single_pred_results, single_ins_results in results:
            ...
            pred_instance_masks.append(
                single_ins_results['pts_instance_mask'])

        ret_dict = cupid_panoptic_seg_eval(
            gt_semantic_masks,
            gt_instance_masks,
            pred_semantic_masks,
            pred_instance_masks,
